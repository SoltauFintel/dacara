// TODO translate, clean up and make own project
package de.mwvb.dacara.base.xml;
...
public class XMLDocument implements Serializable {
	...
	/* TODO XMLDokument sollte zum Interface werden und dann sollte man konkrete
	 * Klassen schreiben die anders heißen.
	 * Außerdem sollte man optional eine XMLDokument-Factory nutzen können.
	 * Denkbar wäre ein Klassensatz, der Exceptions wirft und denkbar wäre ein
	 * Klassensatz, der Exceptions schluckt und in anderer Art und Weise die Fehler
	 * weitergibt.
	 * 
	 * TODO Gemeinsamkeiten von XMLElement und XMLDocument zusammenfassen?
	 * "BaseXMLElement" könnte dabei die Basisklasse für beide sein und eine abstrakte Methode
	 * bereitstellen, die das Element liefert.
	 */
